...
<Cards
  style={{ gridTemplateColumns: "repeat(2,200px)", justifyContent: "center", margin: "4em auto 8rem" }}
>
  <Card
    style={{
      background:
        "linear-gradient(310deg, rgba(0,16,25,1) 31%, rgba(9,22,29,1) 100%)",
    }}
    icon={<Docs />}
    title="Read the Docs"
...
- Every section is written to be succint, including only information that's worth paying attention to.
- If it is better to read from the source material, I'll simply provide the link (e.g. installation instructions).
